...
When you first create a Langium project using the [Yeoman generator](../learn/workflow/scaffold#your-first-example-language), it will only contain a plain TypeScript configuration, without any additional build processes.
