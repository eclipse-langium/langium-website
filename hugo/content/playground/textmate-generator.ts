...
******************************************************************************/
//ATTENTION!!! This file is basically copied from langium-cli!
import type { Grammar } from 'langium';
import { AstUtils, GrammarAST, GrammarUtils, RegExpUtils, stream, IParserConfig } from 'langium';
...
export function generateTextMate(grammar: Grammar, config: LangiumLanguageConfig): TextMateGrammar {
